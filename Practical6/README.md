...
This is the sixth practical where the code executes a matrix multiplication of two different sizes using loops.
We also create two files viz: main.c and  mm.c. 
The mm.c file contains the matrix multiplication function.
